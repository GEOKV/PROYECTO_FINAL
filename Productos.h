...
public:
	...
	void actualizar() {
		...
		if (cn.getConectar()) {
			...
			string pv = to_string(precio_venta);
			string pc = to_string(precio_costo);
			string update = "UPDATE productos SET producto='" + producto + "',idMarca='" + tt + "',descripcion='" + descripcion + "',imagen='" + imagen + "',precio_costo='" + pc + "',precio_venta=" + pv + ",existencia='" + to_string(existencia) + "' WHERE idProducto = '" + t + "'";
